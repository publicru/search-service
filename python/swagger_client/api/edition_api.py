...
class EditionApi(object):
    ...
    def edition_prefix_search_post(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.edition_prefix_search_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.edition_prefix_search_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.edition_prefix_search_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def edition_prefix_search_post_with_http_info(self, **kwargs):  # noqa: E501
        """searches editions by prefix  # noqa: E501

        By passing in the appropriate parameters, you can search for available editions in the system   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.edition_prefix_search_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method edition_prefix_search_post" % key
                )
            params[key] = val
        del params['kwargs']
